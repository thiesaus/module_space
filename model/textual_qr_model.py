...
class Textual_QR_Model(nn.Module):
    def __init__(self, config):
        super(Textual_QR_Model, self).__init__()
        ...
        self.qr_converter = QR_Converter()
    ...
    def forward(self,x):
        ...
        # 2. Text Encoder
        qrs= self.qr_converter.forward(texts)
...
def build_textual_QR_model(config: dict):

    model = Textual_QR_Model(config)
