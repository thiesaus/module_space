...
def train(config: dict):
    ...
    model = build_model6_reduce_size(config=config)
    ...
    if config["WANDB"]:
        ...
        name=f"base6_w_reduce_size_256", 
...
def train_one_epoch(model: Model6_Reduce_Size, train_states: dict, max_norm: float,
...
def test_one_epoch(model:Model6_Reduce_Size,dataloader_test: DataLoader,epoch):
